...
<body>
    <div class="fullscreen">
        ...
        <input type="hidden" value="<?php echo $sessionname . " office"; ?>" id="username_logs">
        <input type="hidden" id="id_logs" value="<?php echo $sessionId ?>">
        <div class="row">
            <ul class="tabs tabs-fixed-width tab-demo z-depth-1 green">
                <li class="tab col s6">
                    <a class="white-text" href="#test1">Personal Data Sheet</a>
                </li>
                <li class="tab col s6" id="c_n">
                    <a class="white-text" href="#test2">Notification <span id="c"></span></a>
                </li>
                <li class="tab col s6">
