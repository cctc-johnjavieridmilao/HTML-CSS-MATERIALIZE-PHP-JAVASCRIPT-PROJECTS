...
{
	echo ' 
              <div class="col-lg-4 col-md-6 mb-4 hvr-float">
                        ...
                        <h4 class="my-4 font-weight-bold">'.mb_strimwidth($row['project'], 0, 20,"...").'</h4>
                         <strong  style="font-size: 12px;color: green;">Posted on: '.$row['date'].'</strong><br><br>
                        <p class="grey-text">'.mb_strimwidth($row['project'], 0, 50,"...").'</p>
                        <a href="project.php?id='.$row['id'].' && codess='.$row['code'].'" class="btn btn-success hvr-bounce-in">Readmore</a>
                    </div>';
}
echo '</div>';
