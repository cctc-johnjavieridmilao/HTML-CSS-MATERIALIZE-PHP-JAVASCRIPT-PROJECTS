...
?>
<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-size="large" data-text="<?php echo $row['title'] ?>" data-via="<?php echo $row['text'] ?>" data-hashtags="ISUCC Alumni" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
 <i style="margin-left: 15px;display: none;"><g:plusone size="tall"></g:plusone></i>
</div>
</div>
<div id="fb-root"></div>
