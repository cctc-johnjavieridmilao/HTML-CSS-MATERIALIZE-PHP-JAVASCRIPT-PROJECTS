           ...
           <div class="row">
               <div class="col-md-12">
                ...
                <li class="breadcrumb-item"><a class="black-text" href="home.php">Home</a><i style="font-size: 10px;" class="fa fa-angle-double-right mx-2" aria-hidden="true"></i></li>
                 <li class="breadcrumb-item"><a class="black-text" href="#"><?php if($_SERVER['PHP_SELF'] == "/alumni/displaysearch1.php"){echo "Search";} ?></a><i style="font-size: 10px;" class="fa fa-angle-double-right mx-2" aria-hidden="true"></i></li>
                <li class="breadcrumb-item"><a class="black-text" href="#"><?php echo $title; ?></a></li>
                    ...
                    <div class="card animated bounceInUp">
                        ...
                        <div class="card-footer">
                          <a  id="reply" onclick="myFunction1()" name="<?php echo $code; ?>"> <span class="far fa-comment"> Add Comment</span></a>
