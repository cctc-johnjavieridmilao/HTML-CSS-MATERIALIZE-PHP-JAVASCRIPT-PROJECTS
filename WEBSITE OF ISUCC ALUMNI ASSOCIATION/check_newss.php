...
$message = "";
	...
	$message =  "<script>swal('Your News is Submitted!','','success');</script>";
	}
	else{
	...
	if(isset($_POST['new_reply'])) {
		...
		toast({
		 ...
		 title: 'your Comment does not Allowed or out of the Topic'
			...
			mysqli_query($connect, "INSERT INTO `tbl_new_children` (`user`, `text`, `date`, `par_code`) VALUES ('$new_reply_name', '$new_reply_text', '$new_reply_date', '$new_reply_code')") or die(mysqli_error());
