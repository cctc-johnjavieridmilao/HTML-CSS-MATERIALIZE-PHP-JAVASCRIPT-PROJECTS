...
$results = mysqli_query($connect,"SELECT COUNT(*) FROM parents");
...
<header>
		...
		<h2 id="txt2"><font color="white"><span class="fas fa-user-graduate" style="color: font-size: 15px;"></span>  ALUMNI ANNOUNCEMENT </font> </h2>
	</header>
   <main class="mt-5 animated bounceInUp">
        ...
        <!--Section: Examples-->
            <section id="examples" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-3 font-weight-bold" style="text-transform: uppercase;color: green;font-size: 30px;">ALL <font color="#eab407">Announcement</font> </h2>
...
$(document).ready(function() {
  ...
  $("#resulta_ann").load("fetch_paginate_ann.php").fadeIn('slow');
  $(".pagination").bootpag({
    ...
    if(true){
      ...
      $("#resulta_ann").hide();
       setTimeout(function(){
        $("#loader_an").hide();
     $("#resulta_ann").fadeOut("slow").load("fetch_paginate_ann.php", {'page':num}).fadeIn(1500);
    },2000);
    }
