      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header" style="background-color: green;text-align: center;">  
                     ...
                     <h4 class="modal-title" id="modal-titles" style="font-size: 18px;color: white;"> <span class="fas fa-user"> User Feedback</span></h4>  
                </div>  
 ...
 $(document).ready(function(){  
      ...
      //$('.view_data').click(function(){  
       ...
       $('#example2').on('click', '.view_data', function(){  
           var employee_id = $(this).attr("id");  
           $.ajax({  
                url:"select_message_nameuser.php",  
                method:"post",  
                data:{employee_id:employee_id},  
                beforeSend:function(){
                  $('.view_data'+employee_id).html($('#spinner' + employee_id).show()); 
