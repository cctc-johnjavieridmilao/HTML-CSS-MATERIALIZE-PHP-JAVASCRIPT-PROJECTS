      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header" style="background-color: green;text-align: center;">  
                     ...
                     <h4 class="modal-title" style="font-size: 18px;color: white;"> <span class="fas fa-bullhorn"> Edit Announcement</span></h4>  
                </div>  
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          <label>Edit Title</label>
                          <input type="text" name="title" class="form-control" oninvalid="alert('# number is not Alowed')"  pattern="[^#]*" id="title">
                          <br/>
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header" style="background-color: green;text-align: center;">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title" style="color: white;font-size: 18px;"> <span class="fas fa-bullhorn"> AnnounceMent</span></h4>  
                </div>  
      ...
      $('#example2').on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                ...
                beforeSend:function(){
                 ...
                 $('.edit_data'+news_id).html($('#spniner_edit_ann'+news_id).show());
                },
                success:function(data){  
                  setTimeout(function(){
                  $('.edit_data').attr('disabled',false);
                   $('.edit_data'+news_id).html($('#spniner_edit_ann'+news_id).hide());
