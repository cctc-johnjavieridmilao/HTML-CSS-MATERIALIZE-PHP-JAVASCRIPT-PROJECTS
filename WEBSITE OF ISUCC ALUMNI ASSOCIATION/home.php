...
@keyframes lds-ring {
  ...
  <body>
    <?php
    $linkhere = '<a href="user_records.php" id="linkhere">Click Here!</a>';
    if (isset($_SESSION['success'])):
     echo "<script>swal('Survey Completed Thankyou!','','success');</script>";
   endif;
   unset($_SESSION['success']); 

   if (isset($_SESSION['Already_Login'])):
    echo "<script>swal('You have Already an Account No Need to Register','','warning');</script>";
  endif;
  unset($_SESSION['Already_Login']);

  if (isset($_SESSION['Done'])):
   echo "<script>swal('Your Already Fill up! You want to update your Records? ".$linkhere."','','warning');</script>";
 endif;
 unset($_SESSION['Done']);

 if(isset($_SESSION['send_success'])):
  echo "<script>swal('Your Feedback Has been Send! Thankyou for the Feedback','','success');</script>";;
endif;
  ...
  <div id="firstPage">
    <div id="cons">
      <h1 class=" animated bounceInDown font-home" id="anim1">
        <font class="animated fadeInDown" id="animated1"> It's</font>
        <font class="animated bounceInDown" id="animated2">great</font>
        <font class="animated bounceInDown" id="animated3">to</font>
        <font class="animated bounceInDown" id="animated4"> have</font>
        <font class="animated bounceInDown" id="animated5"> you</font>
        <font class="animated fadeInDown" id="animated6"> back </font>
        <font class="animated fadeInDown" id="animated7">fellow</font>
        <font color="#6EE04C" class="animated fadeInDown" id="animated8">Graduates</font>
      </h1>
      <p class="animated rotateInUpLeft font-paragraph2 " id="animated9">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="max-height: 100%;overflow: auto;">
        <div class="container" style="width: 100%;">
          <input class="form-control" autocomplete="off" required name="name" id="name" type="search" placeholder="Type Here..." />
          <div id="nameList" style="margin-top: 10px;">
...
$(document).ready(function() {
  ...
  $("#resultss").load("fetch_paginatehome.php").fadeIn('slow');
  $(".pagination").bootpag({
    ...
    if(true){
      ...
      $("#resultss").hide();
       setTimeout(function(){
        $("#resull").hide();
     $("#resultss").fadeOut("slow").load("fetch_paginatehome.php", {'page':num}).fadeIn(1500);
    },2000);
    }
   ...
   <script>
    $("#out").click(function(e) {
      ...
      swal({
        ...
        if (result.value) {
        //swal.showLoading()
        //window.location = "loadingout.php";
        Loader();
      }
    })
    });
...
<script>
  function showOverlay1() {
    el = document.getElementById("showOverlay1");
