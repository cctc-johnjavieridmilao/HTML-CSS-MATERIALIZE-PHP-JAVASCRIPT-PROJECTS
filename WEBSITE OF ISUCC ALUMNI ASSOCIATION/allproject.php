...
<header>
		...
		<h2 id="txt2"><font color="white"><span class="fas fa-user-graduate" style="color: font-size: 15px;"></span>  ALUMNI PROJECT </font> </h2>
	</header>
   <main class="mt-5 animated bounceInUp">
        ...
        <!--Section: Examples-->
            <section id="examples" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-3 font-weight-bold" style="text-transform: uppercase;color: green;font-size: 30px;">ALL <font color="#eab407">Projects & Activities</font> </h2>
...
$(document).ready(function() {
  ...
  $("#resulta_ann").load("fetch_paginate_project.php").fadeIn('slow');
  $(".pagination").bootpag({
    ...
    if(true){
      ...
      $("#resulta_ann").hide();
       setTimeout(function(){
        $("#loader_an").hide();
     $("#resulta_ann").fadeOut("slow").load("fetch_paginate_project.php", {'page':num}).fadeIn(1500);
    },2000);
    }
