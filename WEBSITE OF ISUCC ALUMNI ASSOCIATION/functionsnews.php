...
include 'helper/function.php';
	...
	function get_total() {
		require 'connect.php';
		$result = mysqli_query($connect, "SELECT * FROM `tbl_news` ORDER BY `date` DESC");
	...
	function get_comments() {
		...
		foreach($result as $item) {
			...
			echo '<div class="comment card horizontal" id="'.$par_code.'">'
				...
				$chi_result = mysqli_query($connect, "SELECT * FROM `tbl_new_children` WHERE `par_code`='$par_code' ORDER BY `date` DESC");
