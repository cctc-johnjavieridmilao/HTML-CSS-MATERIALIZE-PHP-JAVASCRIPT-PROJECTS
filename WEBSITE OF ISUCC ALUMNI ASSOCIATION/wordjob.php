        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <a href="alumnijob.php" class="btn btn-danger"><span class="fas fa-arrow-left"> Back</spa></a>
             ...
             <table  class="table table-bordered">
                <thead>
                         <tr>
                                ...
                                <td style="font-family: sans-serif;" width="15%">Employment</td>
                                <td style="font-family: sans-serif;" width="13%">Gender</td>
                                <td style="font-family: sans-serif;" width="13%">Institution</td>
                                <td style="font-family: sans-serif;" width="13%">Program</td>
                                <td style="font-family: sans-serif;" width="13%">YearGraduated</td>
                                <td style="font-family: sans-serif;" width="15%">Job</td>
