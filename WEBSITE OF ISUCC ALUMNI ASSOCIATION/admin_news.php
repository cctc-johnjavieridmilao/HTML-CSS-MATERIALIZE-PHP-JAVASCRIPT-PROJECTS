      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header" style="background-color: green;text-align: center;">  
                     ...
                     <h4 class="modal-title" style="font-size: 18px;color: white;"> <span class="fas fa-newspaper"> Edit News</span></h4>  
                </div>  
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          ...
                          <br/>
                           ...
                           <textarea class="form-control" style="height: 200px;" cols="5" rows="5" name="news" id="newss"></textarea>
                           <br/>
                          <input type="hidden" name="news_id" id="news_id" />  
                </div>  
                <div class="modal-footer">  
                  <button type="submit" name="insert" id="insert" class="btn btn-success"> <span class="fas fa-check"> Updated</span> <i class="fa fa-spinner fa-spin" id="spinnerup" style="display: none;"></i></button>  
...
<div id="dataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header" style="background-color: green;text-align: center;">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title" style="font-size: 18px;color: white;"> <span class="fas fa-newspaper"> News</span></h4>  
                </div>  
...
<!-- jQuery 3 -->
<script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=eon4lnqhce7upxh31er9670wlxax54z24haznnhl514owwdb"></script>
...
<script type="text/javascript">
 //tinymce.init({
  ...
  //plugins: "print,anchor,autoresize,textcolor colorpicker,fullscreen,fullpage,spellchecker,paste",
  //menubar: "file,insert,view,file,tools,edit",
  //toolbar: "print,anchor,forecolor backcolor,fullscreen,fullpage,spellchecker,paste"
//});
    ...
    $('#add').click(function(){  
      ...
      $('#example2').on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                ...
                $('.edit_data'+news_id).html($('#spniner_edit_news'+news_id).show());
                },
                success:function(data){  
                  setTimeout(function(){
                   $('.edit_data').attr('disabled',false);
                   $('.edit_data'+news_id).html($('#spniner_edit_news'+news_id).hide());
      ...
      $('#example2').on('click','.view_data',function(){ 
           ...
           $.ajax({  
                ...
                beforeSend:function(){
                $('.view_data'+employee_id).html($('#spinner' + employee_id).show());
                $('.view_data').attr('disabled', true);
                },
                success:function(data){  
                  setTimeout(function(){
                    $('.view_data').attr('disabled', false);
                    $('.view_data'+employee_id).html($('#spinner' + employee_id).hide());
